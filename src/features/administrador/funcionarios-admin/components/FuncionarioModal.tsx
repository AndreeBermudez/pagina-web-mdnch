...
import { createFuncionario, actualizarFuncionario, type Funcionario } from '../../../../core/services/funcionarios';
				...
				<form onSubmit={handleSubmit}>
					...
					<div className='flex justify-end gap-2 p-4 border-t border-gray-300'>
						<button
							type='button'
							onClick={onClose}
							className='inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-white bg-red-500 border border-gray-300 rounded-md shadow-sm cursor-pointer hover:bg-red-300'>
							Cancelar
						</button>
						<button
							type='submit'
							disabled={loading}
							className='inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-md cursor-pointer hover:bg-blue-700'>
