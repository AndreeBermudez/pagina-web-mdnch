...
export const NoticiasAdmin = () => {
	...
	return (
		<div className='bg-white border border-gray-300 rounded-lg shadow-sm'>
			...
			<div className='overflow-x-auto overflow-y-auto' style={{ maxHeight: '420px', border: '1px solid #f3f4f6' }}>
								...
								<tr key={noticia.noticiaId}>
									...
									<td className='px-4 py-2 whitespace-normal'>
										<div className='flex items-center justify-center'>
											<img src={noticia.direccionImagen} alt={noticia.titulo} className='object-cover w-10 h-10' />
										</div>
									</td>
