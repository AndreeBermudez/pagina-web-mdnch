									...
									<td className='px-4 py-2 text-sm font-medium text-right whitespace-nowrap'>
										<div className='flex items-center justify-center gap-2'>
											<button
												...
												className='inline-flex items-center justify-center p-1 text-sm text-gray-700 bg-yellow-500 border border-gray-300 rounded-md cursor-pointer hover:bg-yellow-300'>
