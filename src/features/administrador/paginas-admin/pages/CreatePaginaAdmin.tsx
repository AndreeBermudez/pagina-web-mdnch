...
import { ModalPagina } from "../components/ModalPagina"

export const CreatePaginaAdmin = () => {
        ...
        <div className="p-6 border-b border-slate-200">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-slate-900">Gestión de Administración</h1>
          ...
          <table className="w-full">
            <thead className="border-b bg-slate-50 border-slate-200">
              <tr>
                ...
                <th className="px-6 py-4 text-xs font-semibold tracking-wider text-left uppercase text-slate-600">Elemento</th>
              ...
              {!loading &&
                filteredData.map((item) => (
                  <tr key={item.id} className="transition-colors hover:bg-slate-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span
                        className={`inline-flex px-2.5 py-1 rounded-full text-xs font-medium border ${getCategoryColor(item.categoria)}`}
                      >
                        {item.categoria}
                      </span>
                    </td>
