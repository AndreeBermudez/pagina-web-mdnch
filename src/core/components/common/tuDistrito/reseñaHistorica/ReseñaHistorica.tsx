...
const historicalItems = [
  {
    year: "1958",
    description: "Fecha en que se asientan los primeros pobladores en la zona que hoy ocupa la urbanización Buenos Aires, capital del distrito de Nuevo Chimbote.",
    icon: "pin" as const
  },
  {
    year: "1960",
    description: "En la margen izquierda del río Lacramarca se producen invasiones y en estos terrenos eriazos donde se instalan los asentamientos humanos de Villa María, Villa María Baja, 1° de Mayo y 3 de Octubre.",
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end">
          <div className="max-w-6xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
            ...
            <p className="text-white/90 max-w-2xl text-sm sm:text-base">
              Descubre la fascinante historia del Distrito de Nuevo Chimbote, desde sus orígenes hasta convertirse en
              una ciudad con más de 200.000 habitantes y un futuro prometedor.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="md:col-span-2 space-y-8">
            <ContentSection title="Orígenes y Crecimiento">
              ...
              <div className="flex items-start mt-6 bg-blue-50 p-4 rounded-lg border-l-4 border-blue-400">
                ...
                <p className="text-sm m-0">
                  Según indican algunos hallazgos arqueológicos encontrados, la riqueza marina existente así como las
                  características de las Bahías: El Ferrol y Samanco, motivó el asentamiento de comunidades nativas,
                  entre otros de origen Mochica; poniendo en evidencia que la pesca, era una actividad económica
                  importante en el territorio actual de Chimbote y Nuevo Chimbote.
                </p>
              </div>
            </ContentSection>
            ...
            <ContentSection title="Desarrollo Urbano">
              <p>
                ...
                desarrollo de la ciudad de Chimbote; y la evolución de esta última está determinada por las tendencias
                del crecimiento de su industria Pesquera y Siderúrgica.
              </p>
              ...
              <p>
                ...
                infraestructura básica: agua, desagüe, red eléctrica y red vial, la comisión CRYRZA elabora el "Plan
                Director de la Municipalidad del Santa" aprobado en 1974, estudio en el que se plantea como área de
                expansión urbana la zona sur de la ciudad de Chimbote.
              </p>
            </ContentSection>
          </div>
        </div>
