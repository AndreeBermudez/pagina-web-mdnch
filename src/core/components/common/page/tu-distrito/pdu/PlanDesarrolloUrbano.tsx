...
import { usePduList } from '../../../../../../features/administrador/pdu-admin/hooks/usePduQuery';
import type { Pdu } from '../../../../../../features/administrador/pdu-admin/schemas/pdu.schema';
import { FaCloudDownloadAlt } from 'react-icons/fa';

export default function PlanDesarrolloUrbano() {
  const { data: documentos, isLoading, error } = usePduList();
  ...
  return (
    <div className="container mx-auto px-4">
      ...
      {isLoading ? (
        ...
        <div>Error al cargar documentos</div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-4">
          {documentos?.map((doc: Pdu) => (
            <div
              key={doc.pduId}
            ...
            >
              ...
              <div className="p-4 pb-2 text-center">
                <div className="mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-blue-200 text-white mb-4">
                  <span className="font-bold">{doc.pduId}</span>
                </div>
              ...
              <div className="px-4 pb-4 flex-1">
                <p className="text-sm text-gray-700 min-h-[60px]">{doc.descripcion}</p>
              </div>
              ...
              <div className="px-4 pb-4">
                <button
                  ...
                  onClick={() => window.open(doc.linkDocumento || '#', '_blank')}
                >
