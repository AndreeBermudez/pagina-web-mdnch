...
interface ExpandedRowNombramientoProps {
    nombramiento: NombramientoPublico;
}

export const ExpandedRowNombramiento = ({ nombramiento }: ExpandedRowNombramientoProps) => {
    const { documentos } = nombramiento;

    const documentosHabilitados = documentos.filter(doc => doc.habilitado);
    const getDocumentosByCategoria = (categoria: string) => documentosHabilitados.filter(doc => doc.categoria === categoria);

    const documentosBase = getDocumentosByCategoria('documento');
    const enlaces = getDocumentosByCategoria('enlace');
                ...
                <td colSpan={5} className='px-6 py-6 border-l-4 border-blue-500 bg-gradient-to-b from-blue-25 to-blue-50'>
                    <div className='max-w-full'>
                        ...
                        <div className='flex flex-col items-center justify-center py-8'>
                            ...
                            <h4 className='text-lg font-semibold text-gray-800 mb-2'>Nombramiento en Preparación</h4>
                            <p className='text-gray-600 text-center max-w-md'>
                                Los documentos de este nombramiento están siendo preparados y serán publicados próximamente.
                            </p>
