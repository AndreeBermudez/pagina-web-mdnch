...
export const SectionPlaces = () => {
	return (
		<section className='py-16 bg-gray-100'>
			<div className='container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mb-15'>
				<div className='mb-16'>
					...
					<div className='grid grid-cols-1 md:grid-cols-2 gap-8 items-center'>
						...
						<div className='space-y-6'>
							<p className='text-gray-600 leading-relaxed'>
								Nuevo Chimbote es una joven ciudad peruana que combina modernidad, naturaleza y cultura en perfecta
								armonía. Ubicada en la costa norte del Perú, se distingue por sus amplias avenidas, espacios verdes
								y una creciente infraestructura urbana diseñada para el bienestar de sus habitantes.
							</p>
