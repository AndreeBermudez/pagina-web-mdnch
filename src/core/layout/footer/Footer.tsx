	...
	return (
		<footer className='w-full bg-gray-900 text-gray-300 relative pt-16 pb-4'>
			...
			<div className='flex flex-col items-center mb-10 px-4 text-center'>
				<h2 className='text-xl md:text-2xl font-bold text-white'>Municipalidad de Nuevo Chimbote</h2>
				<div className='h-1 w-20 bg-blue-700 mt-3 mb-2'></div>
				<p className='text-gray-400 text-sm md:text-base'>Trabajando por el desarrollo</p>
			</div>
